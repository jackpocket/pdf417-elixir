defmodule PDF417.LowLevelEncoderTest do
  ...
  describe "encode" do
    test "it returns an array of the correct symbols" do
      ...
      assert encoded ==
               [
                 [130_728, 125_680, 110_016, 69008, 75288, 100_396, 120_032, 260_649],
                 [130_728, 128_304, 104_412, 126_842, 96414, 119_170, 129_720, 260_649],
                 [130_728, 109_040, 96460, 102_290, 102_290, 102_290, 109_040, 260_649],
                 [130_728, 89720, 122_264, 124_350, 118_172, 113_056, 89980, 260_649]
               ]
    end
  end
end
